...
if __name__ == "__main__":
    ...
    transformations = ['model_learning_rate']
    ...
    simulation_configuration = Helpers.load_from_json(os.path.join(os.getcwd(), "simulation_configurations", "FedAvg.json"))
    ...
    current_save_path = os.path.join(os.getcwd(), 'results', 'model_learning_rate')
    ...
    for learning_rate in learning_rates:
        simulation_configuration['nodes']["model_settings"]["learning_rate"] = learning_rates
        simulation_configuration["orchestrator"]["archiver"]["orchestrator_filename"] = f"model_lr_to_{learning_rate}_central_testset.csv"
        simulation_configuration["orchestrator"]["archiver"]["central_on_local_filename"] = f"model_lr_to_{learning_rate}_local_testsets.csv"
